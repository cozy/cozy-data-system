...
var Client, checkDocType, client, db, encryption, git, toString, updatePermissions;
...
before('permissions_param', function() {
  ...
  return checkDocType(auth, body.docType, (function(_this) {
...
before('permissions', function() {
  var auth;
  auth = req.header('authorization');
  return checkDocType(auth, this.doc.docType, (function(_this) {
    return function(err, appName, isAuthorized) {
      if (!appName) {
        err = new Error("Application is not authenticated");
        return send({
...
before('decryptPassword', function() {
  if ((body.docType == null) || !(body.docType.toLowerCase() === "application")) {
    encryption.decrypt(this.doc.password, (function(_this) {
      return function(err, password) {
        if (err != null) {
          ...
          return _this.doc.password = password;
        }
      };
    })(this));
  }
