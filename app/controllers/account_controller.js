...
before('permission_keys', function() {
  return checkProxyHome(req.header('authorization'), (function(_this) {
    return function(err, isAuthorized) {
      if (!isAuthorized) {
...
before('permission', function() {
  ...
  return checkDocType(auth, "Account", (function(_this) {
...
action('initializeKeys', (function(_this) {
  return function() {
      ...
      if (err) {
        ...
        if ((user.salt != null) && (user.slaveKey != null)) {
          return encryption.logIn(body.password, user, function(err) {
            ...
            return initPassword((function(_this) {
              return function() {
                return send({
                  success: true
                });
