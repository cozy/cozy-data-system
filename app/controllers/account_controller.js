...
var Account, Client, CryptoTools, User, accountManager, checkDocType, checkProxy, client, correctWitness, cryptoTools, db, encryptPassword, randomString, toString, user,
  _this = this;
...
before('permission_keys', function() {
  ...
  return checkProxy(req.header('authorization'), function(err, isAuthorized) {
    return next();
  });
}, {
