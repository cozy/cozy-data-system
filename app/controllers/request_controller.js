...
before('lock request', function() {
  ...
  return compound.app.locker.runIfUnlock(this.lock, (function(_this) {
    return function() {
...
action('results', function() {
  return request.get(this.appName, params, (function(_this) {
...
action('definition', function() {
  return db.get("_design/" + params.type, (function(_this) {
