...
before('permissions', function() {
  ...
  return checkPermissions(auth, this.doc.docType, (function(_this) {
...
action('addAttachment', function() {
  ...
  if (req.files["file"] != null) {
    ...
    if (((_ref = this.doc.binary) != null ? _ref[name] : void 0) != null) {
      return db.get(this.doc.binary[name].id, (function(_this) {
        return function(err, binary) {
      ...
      return db.save(binary, (function(_this) {
        return function(err, binary) {
          return attach(binary, name, file, _this.doc);
        };
      })(this));
