...
var async, db, initializeDSView, productionOrTest, randomString, recoverApp, recoverDesignDocs, recoverDocs, request,
        ...
        return recoverApp((function(_this) {
          return function(apps) {
            return recoverDesignDocs(function(docs) {
              var app, body, doc, i, len, ref, ref1, req_name, type, view;
