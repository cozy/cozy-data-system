...
var Client, Feed, S, async, audio, client, fs, indexer, log, setCouchCredentials, thumb,
        ...
        return function(err, doc) {
          ...
          if (doctype === 'file') {
            return _this.db.get(change.id, function(err, file) {
              var ref1, ref2;
              if (file["class"] === 'music' && (((ref1 = file.binary) != null ? ref1.file : void 0) != null) && !file.audio_metadata) {
                audio.create(file.id, false);
              }
              if (file["class"] === 'image' && (((ref2 = file.binary) != null ? ref2.file : void 0) != null) && !file.binary.thumb) {
