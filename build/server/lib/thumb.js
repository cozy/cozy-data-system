...
createThumb = function(file, force, callback) {
  var addThumb, id, mimetype, _ref, _ref1;
  ...
  if ((((_ref = file.binary) != null ? _ref.thumb : void 0) != null) && (((_ref1 = file.binary) != null ? _ref1.screen : void 0) != null) && !force) {
    log.info("createThumb " + file.id + "/" + file.name + ": already created.");
    return callback();
  } else if (__indexOf.call(whiteList, mimetype) < 0) {
