...
module.exports.create = (req, res, next) ->
    ...
    for target in share.targets
        if not target.recipientUrl? or target.recipientUrl is ''
...
module.exports.handleRecipientAnswer = (req, res, next) ->
    ...
    not share.recipientUrl? or share.recipientUrl is ''  or
    not share.sharerUrl?    or share.sharerUrl is ''     or
    not share.rules?        or not share.rules.length?   or
...
module.exports.validateTarget = (req, res, next) ->
    ...
    not answer.recipientUrl? or answer.recipientUrl  is '' or
    ...
    db.get answer.shareID, (err, doc) ->
        ...
        target = (t for t in doc.targets when t.recipientUrl is \
            answer.recipientUrl)
